...
%--------------------------------------------------------------
% Core nowcasting engine used by the app.
% The UI does not perform model estimation directly; instead, it prepares
% the selected spec/data files and calls this function as the backend.
%--------------------------------------------------------------
